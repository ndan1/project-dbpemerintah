...
@section('content')
    ...
    @endif
    <div class="">
        <form class="mx-auto" style="width:80%; margin-top:50px"
            action="{{ route('profile.update', ['customer_email' => Auth::user()->customer_email]) }}" method="POST">
            @csrf
            <div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="email" id="customer_email" name="customer_email"
                        value="{{ $profile->customer_email ?? '' }}" style="display: none;" readonly>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control border-danger" id="tempat_lahir" name="tempat_lahir"
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control border-danger" id="tgl_lahir" name="tgl_lahir"
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control border-danger" id="inputPassword" name="nik"
                        value="{{ $profile->nik ?? '' }}">
                </div>
            </div>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <select class="form-control border-danger form-select" id="pekerjaan" name="pekerjaan">
                        <option value="Pelajar/mhs" {{ $profile->pekerjaan == 'Pelajar/mhs' ? 'selected' : '' }}>
                            Pelajar/mhs</option>
                        <option value="Karyawan Swasta"
                            {{ $profile->pekerjaan == 'Karyawan Swasta' ? 'selected' : '' }}>Karyawan Swasta</option>
                        <option value="Wiraswasta" {{ $profile->pekerjaan == 'Wiraswasta' ? 'selected' : '' }}>
                            Wiraswasta</option>
                        <option value="Wirausaha" {{ $profile->pekerjaan == 'Wirausaha' ? 'selected' : '' }}>Wirausaha
                        </option>
                    </select>
                </div>
            </div>
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control border-danger" id="alamat" name="alamat"
            ...
            <div class="mb-4 row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control border-danger" id="provinsi" name="provinsi"
                        value="{{ $profile->provinsi ?? '' }}">
                </div>
            </div>
            <div class="text-center">
                <button style="margin: auto" type="submit" class="btn btn-primary text-center"
                    style="height: 6vh;">Simpan</button>
            </div>
        </form>
    </div>
<<<<<<< HEAD
...
>>>>>>> ac7da9d4395bb342d9c0923d29d4aa72deb553f4
@endsection
