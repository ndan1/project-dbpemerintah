...
<div class="container mt-5">
    <h2>Detail Pembayaran Perpanjangan SIM</h2>
    <div class="card">
        <div class="card-header">
            Pembayaran ID: {{ $pembayaran->pembayaranperpanjang_id }}
        </div>
        <div class="card-body">
            ...
            <form action="{{ route('admin.pembayaranperpanjangan.approve', $pembayaran->pembayaranperpanjang_id) }}" method="POST" class="mt-3">
                @csrf
                <button type="submit" class="btn btn-success">Approve</button>
            </form>
            <form action="{{ route('admin.pembayaranperpanjangan.reject', $pembayaran->pembayaranperpanjang_id) }}" method="POST" class="mt-3">
                @csrf
                <div class="mb-3">
