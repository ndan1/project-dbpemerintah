...
@if ($errors->any())
                    ...
                    @endif
    <form class="mx-auto" action="{{route('panjang-sim')}}" method="POST" enctype="multipart/form-data" style="width: 80%;">
        @csrf
        <div class="mb-3 mt-3">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control border-danger" id="namalengkap" name="customer_name" value="{{$profile->customer_name ?? ''}}" disabled>
            </div>
